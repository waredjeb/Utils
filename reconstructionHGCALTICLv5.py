...
for i, v in enumerate(params):
    setattr(process, 'trackstersProducerCLUE3DEM' + str(i), cms.EDProducer('TrackstersProducer',
        ...
        pluginPatternRecognitionByCLUE3D = cms.PSet(
            algo_verbosity = cms.int32(0),
            criticalDensity = cms.vdouble(v[0],v[1], 0.6),
            criticalEtaPhiDistance = cms.vdouble(0.025, 0.025, 0.025),
            criticalSelfDensity = cms.vdouble(v[2],v[3], 0.15),
            criticalXYDistance = cms.vdouble(v[4],v[5], 1.8),
            criticalZDistanceLyr = cms.vint32(int(v[6]) ,int(v[7]), 5),
            cutHadProb = cms.double(v[8]),
            densityEtaPhiDistanceSqr = cms.vdouble(0.0008, 0.0008, 0.0008),
            densityOnSameLayer = cms.bool(bool(int(v[9]))),
            densitySiblingLayers = cms.vint32(int(v[10]), int(v[11]), 3),
            densityXYDistanceSqr = cms.vdouble(v[12],v[13],3.24),
            ...
            eid_output_name_energy = cms.string('output/regressed_energy'),
            eid_output_name_id = cms.string('output/id_probabilities'),
            kernelDensityFactor = cms.vdouble(v[14], v[15], 0.2),
            minNumLayerCluster = cms.vint32(int(v[16]),int(v[17]),2),
            nearestHigherOnSameLayer = cms.bool(False),
            outlierMultiplier = cms.vdouble(v[18],v[19],0.2),
    ...
    setattr(process, 'trackstersProducerCLUE3DHAD' + str(i), cms.EDProducer('TrackstersProducer',
        ...
        pluginPatternRecognitionByCLUE3D = cms.PSet(
            algo_verbosity = cms.int32(0),
            criticalDensity = cms.vdouble(v[20],v[21],v[22]),
            criticalEtaPhiDistance = cms.vdouble(v[23], v[24], v[25]),
            criticalSelfDensity = cms.vdouble(v[26],v[27],v[28]),
            criticalXYDistance = cms.vdouble(v[29], v[30], v[31]),
            criticalZDistanceLyr = cms.vint32(int(v[32]), int(v[33]), int(v[34])),
            cutHadProb = cms.double(0.5),
            densityEtaPhiDistanceSqr = cms.vdouble(v[35], v[36], v[37]),
            densityOnSameLayer = cms.bool(bool(int(v[38]))),
            densitySiblingLayers = cms.vint32(int(v[39]), int(v[40]), int(v[41])),
            densityXYDistanceSqr = cms.vdouble(v[42], v[43], v[44]),
            ...
            eid_output_name_energy = cms.string('output/regressed_energy'),
            eid_output_name_id = cms.string('output/id_probabilities'),
            kernelDensityFactor = cms.vdouble(v[45], v[46], v[47]),
            minNumLayerCluster = cms.vint32(int(v[48]), int(v[49]), int(v[50])),
            nearestHigherOnSameLayer = cms.bool(False),
            outlierMultiplier = cms.vdouble(v[51], v[52], v[53]),
            rescaleDensityByZ = cms.bool(False),
            type = cms.string('CLUE3D'),
            useAbsoluteProjectiveScale = cms.bool(True),
            useClusterDimensionXY = cms.bool(False)
    ...
    setattr(process, 'mergedTrackstersProducer' + str(i), cms.EDProducer("TracksterLinksProducer",
            ...
            wind = cms.double(v[54]),
            angle0 = cms.double(v[55]),
            angle1 = cms.double(v[56]),
            angle2 = cms.double(v[57]),
            maxConeHeight = cms.double(v[58]),
            pcaQuality = cms.double(v[59]),
            pcaQualityLCSize = cms.uint32(int(v[60])),
            dotProdCut = cms.double(v[61]),
            maxDistSkeletonsSq = cms.double(v[62]),
            algo_verbosity = cms.int32(0),
